...
curl -o image.zip https://github.com/JerryKott/stash/tree/master/image/image.zip
unzip image.zip

#Get and unpack the installation script
curl -o script.zip https://github.com/JerryKott/stash/tree/master/scripts/macx.zip
unzip script.zip
...
curl -o examples.zip https://github.com/JerryKott/stash/tree/master/examples.zip
unzip examples.zip
mv examples $TARGET/
